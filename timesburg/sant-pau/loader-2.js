...
async function loadPayload() {
  ...
  if (!PAYLOAD_URL) throw new Error("url.json no contiene 'url'");

  // ✅ 3. Crear clave de caché dependiente de la URL
  const cacheKey = PAYLOAD_URL.length + "_" +
  ...
  if (!data) throw new Error("HorarioTimes: Base64 inválido");
